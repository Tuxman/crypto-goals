  ...
  async created() {
    ...
    if(res.status === 200) {
      res.data.forEach(element => {
        element.price_change_percentage_1h_in_currency = element.price_change_percentage_1h_in_currency.toFixed(2) + '%';

        element.price_change_percentage_24h_in_currency = element.price_change_percentage_24h_in_currency.toFixed(2) + '%';

        element.price_change_percentage_7d_in_currency = element.price_change_percentage_7d_in_currency.toFixed(2) + '%';
